...
import com.StudentEnrollmentSystem.pages.AdSearUsngExitmark;
import com.StudentEnrollmentSystem.utilities.ExcelUtility4;

public class AdSearUsngExitmarkTestClass extends TestBase {
	
	AdSearUsngExitmark objLogin;
	
	 @Test(priority=1)
	    public void AdSearUsngCourse() throws Exception {
	    
	    	//create login page object
	    	objLogin=new AdSearUsngExitmark(driver);
	    ...
	    String listSearch=ExcelUtility4.getCellData(0,7);
