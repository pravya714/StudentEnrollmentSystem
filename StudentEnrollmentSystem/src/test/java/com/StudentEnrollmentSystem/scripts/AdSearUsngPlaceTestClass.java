...
import com.StudentEnrollmentSystem.pages.AdSearUsngPlace;
import com.StudentEnrollmentSystem.utilities.ExcelUtility4;

public class AdSearUsngPlaceTestClass extends TestBase{
	
	AdSearUsngPlace objLogin;
	
	 @Test(priority=1)
	    public void AdSearUsngCourse() throws Exception {
	    
	    	//create login page object
	    	objLogin=new AdSearUsngPlace(driver);
	    ...
	    String listSearch=ExcelUtility4.getCellData(0,6);
