...
import com.StudentEnrollmentSystem.pages.AdSearUsngQualification;
import com.StudentEnrollmentSystem.utilities.ExcelUtility4;

public class AdSearUsngQualificationTestClass extends TestBase {
	
	AdSearUsngQualification objLogin;
	
	 @Test(priority=1)
	    public void AdSearUsngQualification() throws Exception {
	    
	    	//create login page object
	    	objLogin=new AdSearUsngQualification(driver);
	    ...
	    String listSearch=ExcelUtility4.getCellData(0,3);
