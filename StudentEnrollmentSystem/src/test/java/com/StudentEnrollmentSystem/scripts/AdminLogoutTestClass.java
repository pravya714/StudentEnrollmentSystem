...
import com.StudentEnrollmentSystem.pages.AdminLogout;
import com.StudentEnrollmentSystem.utilities.ExcelUtility4;

public class AdminLogoutTestClass extends TestBase {
	
	AdminLogout objLogin;
	
	 @Test(priority=1)
	    public void AdminLogout() throws Exception {
	    
	    	//create login page object
	    	objLogin=new AdminLogout(driver);
